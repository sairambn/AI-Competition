  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      <header className="mb-10 animate-fade-up">
        <p className="text-sm font-medium text-primary">Problems</p>
        <h1 className="mt-2 text-3xl text-foreground sm:text-4xl">
          Problem statement generator
        </h1>
        <p className="mt-3 max-w-2xl text-muted-foreground">
          Enter team details, then get a free problem — or click a problem to claim it.
          Assignments appear in the board below.
        </p>
      ...
      <section className="mb-14">
        <div className="animate-fade-up border border-border bg-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 p-6">
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-md border border-input bg-background px-3 py-2.5 text-sm outline-none ring-ring focus:ring-2 focus:ring-primary/40"
                />
              </div>
              <div className="space-y-2">
            ...
            <button
              type="submit"
              className="inline-flex w-full items-center justify-center rounded-md bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground hover:opacity-90 sm:w-auto"
            >
        ...
        {(error || claimHint) && (
          <div className="mt-6 flex items-start gap-3 rounded-md border border-destructive/30 bg-destructive/10 px-4 py-3 text-sm text-destructive">
            ...
            <div className="border border-border bg-card p-6 sm:p-8">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {(registered || takenIds.has(result.problem.id)) && (
                  <span className="inline-flex items-center gap-1 rounded bg-destructive/20 px-2 py-0.5 text-xs font-bold text-destructive">
              ...
              {registered ? (
                <div className="mt-6 flex items-start gap-2 rounded-md border border-primary/30 bg-primary/10 px-4 py-3 text-sm">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-md bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground hover:opacity-90 disabled:opacity-60"
                  >
                    {registering ? (
                      <>
      ...
      <section>
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
          <h2 className="text-xl text-foreground">All problem ideas</h2>
        ...
        <p className="mb-4 text-sm text-muted-foreground">
          Click a <strong>free</strong> problem to select it. Taken items show the{" "}
              ...
              >
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {isTaken ? (
                    ...
                    <span className="rounded bg-easy/20 px-2 py-0.5 text-xs font-bold text-easy-foreground">
                      Free — click to claim
                    </span>
                  )}
                </div>
                ...
                {isTaken && claim?.teamName && (
                  <p className="mt-2 rounded-md border border-destructive/20 bg-destructive/10 px-3 py-2 text-sm">
